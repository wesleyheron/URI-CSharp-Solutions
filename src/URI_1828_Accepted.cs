...
class URI {
    ...
    static void Main(string[] args) { 
            ...
            for (int i = 1; i <= qtdTeste; i++)
            {
                ...
                v1 = valores[0];
                v2 = valores[1];
                if((v1 == "papel" && v2 == "pedra") || (v1 == "papel" && v2 == "Spock") 
                    || (v1 == "tesoura" && v2 == "papel") || (v1 == "tesoura" && v2 == "lagarto")
                    || (v1 == "pedra" && v2 == "lagarto") || (v1 == "pedra" && v2 == "tesoura")
                    || (v1 == "lagarto" && v2 == "papel") || (v1 == "lagarto" && v2 == "Spock")
                    || (v1 == "Spock" && v2 == "pedra") || (v1 == "Spock" && v2 == "tesoura"))
